...
const Main = (props) => {  
  ...
  return (
    <div id='main'>
      ...
      {props.cdOption === 'mainCatalog' && props.selectedFormat === 'compactDiscs' ? <div className="dataWrapper">
        {cds && cds.filter((cd) => {
      ...
      {props.cdOption === 'earlyPressings' && <div className="dataWrapper">
        {cds && cds.filter((cd) => {
          return cd['Box ID'].includes('Older')
        }).map((cd) => {
          return (
      ...
      {props.tapeType === null && props.selectedFormat === 'tapes' ? <div className="dataWrapper">
      ...
      {props.selectedFormat === 'tapes' && <div className="dataWrapper">
      ...
      {props.recordType === null && props.selectedFormat === 'records' ? <div className="dataWrapper">
      ...
      {props.selectedFormat === 'records' && <div className="dataWrapper">
      ...
      {props.selectedFormat === 'compactDiscs' && <div className="dataWrapper">
        {cds && cds.filter((cd) => {
      ...
      <p id='ifNull'>{props.selectedFormat === null ? 'Choose A Format' : null}</p>
    </div>
  )
}
